...
•	/api/v1.0/precipitation: Route to get the last 12 months of precipitation data. The results are converted to a dictionary and returned as JSON.
•	/api/v1.0/stations: Route to get a list of all stations. The results are converted to a list and returned as JSON.
•	/api/v1.0/tobs: Route to get the temperature observations for the previous year for the most active station. The results are converted to a list of dictionaries and returned as JSON.
•	/api/v1.0/<start> and /api/v1.0/<start>/<end>: Routes to get the minimum, average, and maximum temperature for a specified start or start-end range. The results are converted to a list of dictionaries and returned as JSON.
•  Run the Flask Application:
•	The Flask app runs with debug=True for easier debugging during development.
